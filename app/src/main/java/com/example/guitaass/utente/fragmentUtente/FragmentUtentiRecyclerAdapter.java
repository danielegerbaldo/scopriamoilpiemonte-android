...
public class FragmentUtentiRecyclerAdapter extends RecyclerView.Adapter<FragmentUtentiRecyclerAdapter.ViewHolder> {
    List<Utente> utenti;

    private int posizioneEspansa = -1;  //in questa variabile mi salvo qual'è stata l'ultima posizione ad essere stata cliccata


    public FragmentUtentiRecyclerAdapter(List<Utente> utenti){
        this.utenti = utenti;
    }
